...
const SOROBAN_RPC_URL = 'https://horizon-futurenet.stellar.cash:443/soroban/rpc';
  ...
  async function fetchContractValue() {
    ...
    const obj1 = { type: 'address', value:'GATD645QCSAXJUWEVW3AYO4BLGALDRMGKCYXWMUCB4XNSWMSK32MGEQI' };
    const obj2 = { type: 'scvU32', value: 2000 };
    const obj3 = { type: 'scvU32', value: 8 };
    const obj4 = { type: 'scvU32', value: 8 };
    const obj5 = { type: 'bytesn32', value: "60b32529639664bb964182e528f7b48439ebb594632cb1dfc45fc534c3488fb7" };
    const obj6 = { type: 'bytesn32', value: 'b60fb504dd93ab0a003b3859647ef36cc8bf838ba801fa56f34cb3b2e94b9d61' };
    const obj7 = { type: 'bytesn32', value: hexSalt };
    const obj8 = { type: 'vecAddress', value: ["GCJYZB7X74BXD656IZNCB4QOYOPCX5CDRJQ2SNTVH4ADZJGPTGTYDSQV"] };
    const obj9 = { type: 'vecAddress', value: ["GCJYZB7X74BXD656IZNCB4QOYOPCX5CDRJQ2SNTVH4ADZJGPTGTYDSQV"] };
