...
const CONTRACT_ID ='5f4cfe862065ea803389db432320c7a8f18bebf1f3bc2762203c6111daf0a3ee';
...
//  bytes32 =   Buffer.from(bytes32).toString('hex');
  ...
  try {
    ...
    let p7 = ["GBBUGF3HLI24JHTY4NXMY76DGJ4CYUVD6CFY26SV6FOZQQQPJQOBIMUI"]
    let ar_addr = [];
    let scAd;
    let addr;
    let strAddress= "";
