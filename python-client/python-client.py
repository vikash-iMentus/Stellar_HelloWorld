...
secret = os.getenv('PRIVATE_KEY_INVOKER') #"SAAPYAPTTRZMCUZFPG3G66V4ZMHTK4TWA6NS7U4F7Z3IMUD52EK4DDEV"
rpc_server_url = os.getenv('SOROBAN_RPC_URL') #"http://127.0.0.1:8000/soroban/rpc"
contract_id = os.getenv('CONTRACT_ID') #"ca08ea2c19bd47d9e04de0cc86e1440866f6c7f8634095872c38000e1a7cbcd9"
network_passphrase = os.getenv('NETWORK_PASSPHRASE') #Network.STANDALONE_NETWORK_PASSPHRASE
